...
public class ParametricPath {
    ...
    public ParametricPath(Function[] orderedFunctions, Vector2D[] newTranslations, double[] newRanges, double[][] newDefRanges, double[] newAngles) throws FunctionFormatException {

        // information to parametrize
        functions = Resources.Function.copy(orderedFunctions);
